        ...
        return (
            <button
                ...
                className={cn(
                    ...
                    {
                        'bg-brand text-white hover:bg-brand-accent shadow-sm': variant === 'primary',
                        'bg-transparent border border-border text-text-primary hover:bg-black/5': variant === 'secondary',
