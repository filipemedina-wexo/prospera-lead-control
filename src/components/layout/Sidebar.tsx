...
const navByProfile: Record<UserProfile, NavItem[]> = {
    admin: [{ icon: LayoutDashboard, label: 'Cockpit', id: 'admin-dashboard' }, { icon: Building2, label: 'Incorporadoras', id: 'admin-incorporadoras' }, { icon: Store, label: 'Imobiliárias', id: 'admin-imobiliarias' }, { icon: Users, label: 'Corretores', id: 'admin-corretores' }],
